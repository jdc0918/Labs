...
//			if(f!=null) this.focus = f;
//			if (v!=null) this.vertex = v;
//			if (d!=null) this.directrix = d;
			if ((f!=null)&&(v!=null)&&(d!=null)){
				this.focus = f;
				this.vertex = v;
				this.directrix = d;
			}
		...
		public boolean equals(Object o) {
			...
			if (!(this.focus instanceof Point)) return false;
			Parabola that = (Parabola) o;
			if (!(that.focus instanceof Point)) return false;
			// Check the focus
			
			//if either points is not-a-number then..			
			//check to see if that not-a-number is a NULL 
