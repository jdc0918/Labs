...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_6UAdOj/iteration_E6a7qA/BFF_testcase_FtYafA/sf_987dd60dc962e6d702a64cc084c3cb01-1127.csv
...
siginfo:$1 = {si_signo = 6, si_errno = 0, si_code = -6, _sifields = {_pad = {26501, 1000, 0 <repeats 26 times>}, _kill = {si_pid = 26501, si_uid = 1000}, _timer = {si_tid = 26501, si_overrun = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _rt = {si_pid = 26501, si_uid = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _sigchld = {si_pid = 26501, si_uid = 1000, si_status = 0, si_utime = 0, si_stime = 0}, _sigfault = {si_addr = 0x3e800006785, _addr_lsb = 0, _addr_bnd = {_lower = 0x0, _upper = 0x0}}, _sigpoll = {si_band = 4294967322501, si_fd = 0}}}
si_addr:$2 = (void *) 0x3e800006785
...
#3  0x00007ffff71ee651 in malloc_printerr (ar_ptr=0x7fffffffcfe0, ptr=0x6f4200, str=0x7ffff72fd2e0 "malloc(): memory corruption (fast)", action=3) at malloc.c:5006
        buf = "00000000006f4200"
        cp = <optimized out>
        ar_ptr = 0x7fffffffcfe0
        ptr = 0x6f4200
...
#7  0x000000000042b4f7 in __gnu_cxx::new_allocator<std::pair<__gnu_cxx::__normal_iterator<char*, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > >, int> >::allocate (this=0x7fffffffd370, __n=6) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/ext/new_allocator.h:104
No locals.
...
#17 0x0000000000403f56 in main (argc=2, argv=0x7fffffffddb8) at csvParser.cpp:55
...
rsi            0x6785	26501
rdi            0x6785	26501
rbp            0x7fffffffcf50	0x7fffffffcf50
...
r11            0x246	582
r12            0x62	98
r13            0x7fffffffcd68	140737488342376
r14            0x7fffffffcd68	140737488342376
r15            0x2	2
...
A debugging session is active.
	...
	Inferior 1 [process 26501] will be killed.
