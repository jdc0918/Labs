...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_6UAdOj/iteration_51o8Qx/BFF_testcase_t2YHYI/sf_987dd60dc962e6d702a64cc084c3cb01-284.csv

Description: Access violation on source operand
Short description: SourceAv (19/22)
Hash: ff4aa9018583ab63a4b114055f96b48e.547d2ae3cdbb4d4116a3014fa6c90bf4
...
Mapped address spaces:
          ...
          Start Addr           End Addr       Size     Offset objfile
            ...
            0x657000           0x78e000   0x137000        0x0 [heap]
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 1, _sifields = {_pad = {15127920, 0, 64193920, 0, -2002134192, 32707, -502054432, 32767, -2002134160, 32707, 502054433, -32768, -502054433, 32767, 5863560, 0, 0, 0, 0, 0, 0, 0, 67472688, 0, 40954560, 0, -502053692, 32767}, _kill = {si_pid = 15127920, si_uid = 0}, _timer = {si_tid = 15127920, si_overrun = 0, si_sigval = {sival_int = 64193920, sival_ptr = 0x3d38580}}, _rt = {si_pid = 15127920, si_uid = 0, si_sigval = {sival_int = 64193920, sival_ptr = 0x3d38580}}, _sigchld = {si_pid = 15127920, si_uid = 0, si_status = 64193920, si_utime = -8599100876843384832, si_stime = -2156307366251823165}, _sigfault = {si_addr = 0xe6d570, _addr_lsb = 64193920, _addr_bnd = {_lower = 0x7fc388a9db50, _upper = 0x7fffe21341e0}}, _sigpoll = {si_band = 15127920, si_fd = 64193920}}}
si_addr:$2 = (void *) 0xe6d570
...
#0  malloc_consolidate (av=av@entry=0x7ffff7530b20 <main_arena>) at malloc.c:4169
        ...
        bck = <optimized out>
        fwd = <optimized out>
#1  0x00007ffff71ec678 in _int_free (av=0x7ffff7530b20 <main_arena>, p=<optimized out>, have_lock=0) at malloc.c:4075
        size = 83520
        fb = <optimized out>
...
#2  0x00007ffff71f053c in __GI___libc_free (mem=<optimized out>) at malloc.c:2968
        ar_ptr = <optimized out>
        p = <optimized out>
        hook = <optimized out>
#3  0x0000000000409bb0 in __gnu_cxx::new_allocator<std::__detail::_State<std::__cxx11::regex_traits<char> > >::deallocate (this=0x6ae598, __p=0x7799d0) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/ext/new_allocator.h:110
No locals.
#4  0x0000000000409b80 in std::allocator_traits<std::allocator<std::__detail::_State<std::__cxx11::regex_traits<char> > > >::deallocate (__a=..., __p=0x7799d0, __n=16) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/alloc_traits.h:517
No locals.
#5  0x0000000000409b1b in std::_Vector_base<std::__detail::_State<std::__cxx11::regex_traits<char> >, std::allocator<std::__detail::_State<std::__cxx11::regex_traits<char> > > >::_M_deallocate (this=0x6ae598, __p=0x7799d0, __n=16) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/stl_vector.h:178
No locals.
#6  0x0000000000409949 in std::_Vector_base<std::__detail::_State<std::__cxx11::regex_traits<char> >, std::allocator<std::__detail::_State<std::__cxx11::regex_traits<char> > > >::~_Vector_base (this=0x6ae598) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/stl_vector.h:160
No locals.
#7  0x00000000004096b8 in std::vector<std::__detail::_State<std::__cxx11::regex_traits<char> >, std::allocator<std::__detail::_State<std::__cxx11::regex_traits<char> > > >::~vector (this=0x6ae598) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/stl_vector.h:425
No locals.
#8  0x0000000000409f93 in std::__detail::_NFA<std::__cxx11::regex_traits<char> >::~_NFA (this=0x6ae560) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_automaton.h:157
No locals.
#9  0x0000000000409f59 in __gnu_cxx::new_allocator<std::__detail::_NFA<std::__cxx11::regex_traits<char> > >::destroy<std::__detail::_NFA<std::__cxx11::regex_traits<char> > > (this=0x6ae560, __p=0x6ae560) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/ext/new_allocator.h:124
No locals.
#10 0x0000000000409ef8 in std::allocator_traits<std::allocator<std::__detail::_NFA<std::__cxx11::regex_traits<char> > > >::destroy<std::__detail::_NFA<std::__cxx11::regex_traits<char> > > (__a=..., __p=0x6ae560) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/alloc_traits.h:542
No locals.
#11 0x0000000000409288 in std::_Sp_counted_ptr_inplace<std::__detail::_NFA<std::__cxx11::regex_traits<char> >, std::allocator<std::__detail::_NFA<std::__cxx11::regex_traits<char> > >, (__gnu_cxx::_Lock_policy)2>::_M_dispose (this=0x6ae550) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr_base.h:531
No locals.
#12 0x0000000000428ff5 in std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release (this=0x6ae550) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr_base.h:150
No locals.
#13 0x0000000000428faa in std::__shared_count<(__gnu_cxx::_Lock_policy)2>::~__shared_count (this=0x7fffffffd988) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr_base.h:659
No locals.
#14 0x0000000000429189 in std::__shared_ptr<std::__detail::_NFA<std::__cxx11::regex_traits<char> > const, (__gnu_cxx::_Lock_policy)2>::~__shared_ptr (this=0x7fffffffd980) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr_base.h:925
No locals.
#15 0x0000000000429165 in std::shared_ptr<std::__detail::_NFA<std::__cxx11::regex_traits<char> > const>::~shared_ptr (this=0x7fffffffd980) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr.h:93
No locals.
#16 0x0000000000404ef3 in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::~basic_regex (this=0x7fffffffd970) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:531
No locals.
#17 0x0000000000404894 in main (argc=2, argv=0x7fffffffddb8) at csvParser.cpp:99
...
rax            0x779298	7836312
rbx            0x6f42d0	7291600
rcx            0x7fffffffd200	140737488343552
rdx            0x71	113
rsi            0x0	0
rdi            0x7ffff7530b20	140737342802720
rbp            0xe6d568	0xe6d568
rsp            0x7fffffffd1b0	0x7fffffffd1b0
r8             0x70ac50	7384144
r9             0x6af140	7008576
r10            0x7ffff7530b78	140737342802808
r11            0x7ffff7530b50	140737342802768
r12            0x779298	7836312
r13            0xb0	176
...
A debugging session is active.
	...
	Inferior 1 [process 24461] will be killed.
