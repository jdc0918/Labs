...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_6UAdOj/iteration_IVjciu/BFF_testcase_0aKznp/sf_d704174fc94c8ca37a7f1aad4f1b2c4e-1432.csv
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 1, _sifields = {_pad = {113705, 0, 43496816, 0, 592796496, 32703, 18904368, 32764, 592796528, 32703, -18904367, -32765, 18904367, 32764, 5863560, 0, 0, 0, 0, 0, 0, 0, 46726080, 0, 20257472, 0, 18905108, 32764}, _kill = {si_pid = 113705, si_uid = 0}, _timer = {si_tid = 113705, si_overrun = 0, si_sigval = {sival_int = 43496816, sival_ptr = 0x297b570}}, _rt = {si_pid = 113705, si_uid = 0, si_sigval = {sival_int = 43496816, sival_ptr = 0x297b570}}, _sigchld = {si_pid = 113705, si_uid = 0, si_status = 43496816, si_utime = 2546041563503394816, si_stime = 81193642311581631}, _sigfault = {si_addr = 0x1bc29, _addr_lsb = 43496816, _addr_bnd = {_lower = 0x7fbf23555b50, _upper = 0x7ffc01207530}}, _sigpoll = {si_band = 113705, si_fd = 43496816}}}
...
A debugging session is active.
	...
	Inferior 1 [process 27255] will be killed.
