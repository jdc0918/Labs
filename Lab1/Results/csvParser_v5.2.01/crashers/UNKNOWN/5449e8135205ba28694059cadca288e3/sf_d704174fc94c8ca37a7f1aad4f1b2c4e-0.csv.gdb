...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dYB3wS/iteration_QITKsK/BFF_testcase_1xaaoE/sf_d704174fc94c8ca37a7f1aad4f1b2c4e-0.csv
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 2, _sifields = {_pad = {-141284515, 32767, 66278160, 0, -2008908976, 32616, -1674891408, 32767, -2008908944, 32616, 1674891409, -32768, -1674891409, 32767, 5863560, 0, 0, 0, 0, 0, 0, 0, 67783072, 0, 43035312, 0, -1674890668, 32767}, _kill = {si_pid = -141284515, si_uid = 32767}, _timer = {si_tid = -141284515, si_overrun = 32767, si_sigval = {sival_int = 66278160, sival_ptr = 0x3f35310}}, _rt = {si_pid = -141284515, si_uid = 32767, si_sigval = {sival_int = 66278160, sival_ptr = 0x3f35310}}, _sigchld = {si_pid = -141284515, si_uid = 32767, si_status = 66278160, si_utime = -8628198352560848896, si_stime = -7193603821711360152}, _sigfault = {si_addr = 0x7ffff7942b5d, _addr_lsb = 66278160, _addr_bnd = {_lower = 0x7f6888427b50, _upper = 0x7fff9c2b2f70}}, _sigpoll = {si_band = 140737347070813, si_fd = 66278160}}}
si_addr:$2 = (void *) 0x7ffff7942b5d

#0  __mempcpy_sse2 () at ../sysdeps/x86_64/memcpy.S:166
No locals.
#1  0x00007ffff71e76ce in __GI__IO_default_xsputn (f=f@entry=0x7ffff7531620 <_IO_2_1_stdout_>, data=data@entry=0x7ffff7942b5d, n=n@entry=107) at genops.c:438
        count = 107
        s = <optimized out>
        more = 107
        s = 0x7ffff7942b5d <error: Cannot access memory at address 0x7ffff7942b5d>
        more = 107
#2  0x00007ffff71e52c7 in _IO_new_file_xsputn (f=0x7ffff7531620 <_IO_2_1_stdout_>, data=<optimized out>, n=4268112) at fileops.c:1352
        ...
        s = <optimized out>
        to_do = 4268112
#3  0x00007ffff71da7bb in __GI__IO_fwrite (buf=0x7ffff7530b78 <main_arena+88>, size=1, count=4268112, fp=0x7ffff7531620 <_IO_2_1_stdout_>) at iofwrite.c:39
...
#5  0x0000000000404108 in main (argc=2, argv=0x7fffffffde18) at csvParser.cpp:61
        i = 1
...
rax            0x66bf90	6733712
rbx            0x6b	107
rcx            0xfffffffd	4294967293
rdx            0x68	104
rsi            0x7ffff7942b5d	140737347070813
rdi            0x66af90	6729616
rbp            0x6b	0x6b
rsp            0x7fffffffd4d8	0x7fffffffd4d8
...
r13            0x6b	107
r14            0x7ffff7942bc8	140737347070920
r15            0x411000	4263936
