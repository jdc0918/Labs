...
__GI___libc_free (mem=0x18571) at malloc.c:2951
2951	malloc.c: No such file or directory.

Found_with_CERT_BFF_2.8
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dYB3wS/iteration_WPC4rX/BFF_testcase_n8a5vX/sf_d704174fc94c8ca37a7f1aad4f1b2c4e-7rPaif-minimized.csv
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 1, _sifields = {_pad = {99689, 0, 43955296, 0, -2078123176, 32633, 515177024, 32766, -2078123152, 32633, -515177023, -32767, 515177023, 32766, 5863560, 0, 0, 0, 0, 0, 0, 0, 47548896, 0, 20708016, 0, 515177764, 32766}, _kill = {si_pid = 99689, si_uid = 0}, _timer = {si_tid = 99689, si_overrun = 0, si_sigval = {sival_int = 43955296, sival_ptr = 0x29eb460}}, _rt = {si_pid = 99689, si_uid = 0, si_sigval = {sival_int = 43955296, sival_ptr = 0x29eb460}}, _sigchld = {si_pid = 99689, si_uid = 0, si_status = 43955296, si_utime = -8925471077979652096, si_stime = 2212668469730639737}, _sigfault = {si_addr = 0x18569, _addr_lsb = 43955296, _addr_bnd = {_lower = 0x7f7984225b58, _upper = 0x7ffe1eb4fa40}}, _sigpoll = {si_band = 99689, si_fd = 43955296}}}
si_addr:$2 = (void *) 0x18569

#0  __GI___libc_free (mem=0x18571) at malloc.c:2951
        ar_ptr = <optimized out>
        p = <optimized out>
        hook = 0x0
#1  0x00000000004045c1 in main (argc=2, argv=0x7fffffffde08) at csvParser.cpp:82
...
r8             0x0	0
r9             0x3534746e6563	58499407963491
r10            0x0	0
...
A debugging session is active.
	...
	Inferior 1 [process 4517] will be killed.
