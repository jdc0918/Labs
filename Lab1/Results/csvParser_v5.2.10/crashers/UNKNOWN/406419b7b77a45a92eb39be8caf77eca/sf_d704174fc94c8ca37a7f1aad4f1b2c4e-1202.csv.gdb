...
__GI___libc_free (mem=0x1bc31) at malloc.c:2951
2951	malloc.c: No such file or directory.

Found_with_CERT_BFF_2.8
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dtaBif/iteration_NMEj6J/BFF_testcase_OfEHUh/sf_d704174fc94c8ca37a7f1aad4f1b2c4e-1202.csv
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 1, _sifields = {_pad = {113705, 0, 59953472, 0, -128599216, 32717, 1092366256, 32765, -128599184, 32717, -1092366255, -32766, 1092366255, 32765, 5863560, 0, 0, 0, 0, 0, 0, 0, 63176112, 0, 36694704, 0, 1092366996, 32765}, _kill = {si_pid = 113705, si_uid = 0}, _timer = {si_tid = 113705, si_overrun = 0, si_sigval = {sival_int = 59953472, sival_ptr = 0x392d140}}, _rt = {si_pid = 113705, si_uid = 0, si_sigval = {sival_int = 59953472, sival_ptr = 0x392d140}}, _sigchld = {si_pid = 113705, si_uid = 0, si_status = 59953472, si_utime = -552329427011239936, si_stime = 4691677344773996493}, _sigfault = {si_addr = 0x1bc29, _addr_lsb = 59953472, _addr_bnd = {_lower = 0x7fcdf855bb50, _upper = 0x7ffd411c2fb0}}, _sigpoll = {si_band = 113705, si_fd = 59953472}}}
si_addr:$2 = (void *) 0x1bc29

#0  __GI___libc_free (mem=0x1bc31) at malloc.c:2951
        ar_ptr = <optimized out>
        p = <optimized out>
        hook = 0x0
#1  0x00000000004045c1 in main (argc=2, argv=0x7fffffffde18) at csvParser.cpp:82
...
std::shared_ptr (count 1, weak 0) 0x66c070}
...
rax            0x0	0
rbx            0x0	0
rcx            0x66d3e8	6738920
rdx            0x6	6
rsi            0x7fffffffd870	140737488345200
rdi            0x1bc31	113713
rbp            0x7fffffffdd30	0x7fffffffdd30
rsp            0x7fffffffd5b0	0x7fffffffd5b0
r8             0x0	0
...
A debugging session is active.
	...
	Inferior 1 [process 13526] will be killed.
