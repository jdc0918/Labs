...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dtaBif/iteration_XtYIQz/BFF_testcase_qk7w8n/sf_987dd60dc962e6d702a64cc084c3cb01-334.csv
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 1, _sifields = {_pad = {15127920, 0, 58177584, 0, 451124048, 32541, -1686278832, 32764, 451124080, 32541, 1686278833, -32765, -1686278833, 32764, 5863560, 0, 0, 0, 0, 0, 0, 0, 61894944, 0, 34937520, 0, -1686278092, 32764}, _kill = {si_pid = 15127920, si_uid = 0}, _timer = {si_tid = 15127920, si_overrun = 0, si_sigval = {sival_int = 58177584, sival_ptr = 0x377b830}}, _rt = {si_pid = 15127920, si_uid = 0, si_sigval = {sival_int = 58177584, sival_ptr = 0x377b830}}, _sigchld = {si_pid = 15127920, si_uid = 0, si_status = 58177584, si_utime = 1937563032599134208, si_stime = -7242512435377045731}, _sigfault = {si_addr = 0xe6d570, _addr_lsb = 58177584, _addr_bnd = {_lower = 0x7f1d1ae39b50, _upper = 0x7ffc9b7d6d50}}, _sigpoll = {si_band = 15127920, si_fd = 58177584}}}
...
No locals.
#13 0x0000000000428faa in std::__shared_count<(__gnu_cxx::_Lock_policy)2>::~__shared_count (this=0x7fffffffd9e8) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr_base.h:659
No locals.
#14 0x0000000000429189 in std::__shared_ptr<std::__detail::_NFA<std::__cxx11::regex_traits<char> > const, (__gnu_cxx::_Lock_policy)2>::~__shared_ptr (this=0x7fffffffd9e0) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr_base.h:925
No locals.
#15 0x0000000000429165 in std::shared_ptr<std::__detail::_NFA<std::__cxx11::regex_traits<char> > const>::~shared_ptr (this=0x7fffffffd9e0) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/shared_ptr.h:93
No locals.
#16 0x0000000000404ef3 in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::~basic_regex (this=0x7fffffffd9d0) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:531
No locals.
#17 0x0000000000404894 in main (argc=2, argv=0x7fffffffde18) at csvParser.cpp:99
...
rcx            0x7fffffffd260	140737488343648
rdx            0x71	113
rsi            0x0	0
...
A debugging session is active.
	...
	Inferior 1 [process 11399] will be killed.
