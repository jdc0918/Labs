...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dtaBif/iteration_xkZ78h/BFF_testcase_c6cKv5/sf_987dd60dc962e6d702a64cc084c3cb01-851.csv
...
siginfo:$1 = {si_signo = 6, si_errno = 0, si_code = -6, _sifields = {_pad = {12736, 1000, 0 <repeats 26 times>}, _kill = {si_pid = 12736, si_uid = 1000}, _timer = {si_tid = 12736, si_overrun = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _rt = {si_pid = 12736, si_uid = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _sigchld = {si_pid = 12736, si_uid = 1000, si_status = 0, si_utime = 0, si_stime = 0}, _sigfault = {si_addr = 0x3e8000031c0, _addr_lsb = 0, _addr_bnd = {_lower = 0x0, _upper = 0x0}}, _sigpoll = {si_band = 4294967308736, si_fd = 0}}}
si_addr:$2 = (void *) 0x3e8000031c0
...
#3  0x00007ffff71ee651 in malloc_printerr (ar_ptr=0x7fffffffcf80, ptr=0x6f41b0, str=0x7ffff72fd2e0 "malloc(): memory corruption (fast)", action=3) at malloc.c:5006
        buf = "00000000006f41b0"
        cp = <optimized out>
        ar_ptr = 0x7fffffffcf80
        ptr = 0x6f41b0
...
#7  0x000000000042aac1 in __gnu_cxx::new_allocator<std::__cxx11::sub_match<__gnu_cxx::__normal_iterator<char*, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > > > >::allocate (this=0x7fffffffd388, __n=4) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/ext/new_allocator.h:104
No locals.
...
#19 0x0000000000403f56 in main (argc=2, argv=0x7fffffffde18) at csvParser.cpp:55
...
rsi            0x31c0	12736
rdi            0x31c0	12736
rbp            0x7fffffffcef0	0x7fffffffcef0
rsp            0x7fffffffcb58	0x7fffffffcb58
r8             0x6	6
r9             0x0	0
r10            0x8	8
r11            0x246	582
...
r14            0x7fffffffcd08	140737488342280
r15            0x2	2
...
A debugging session is active.
	...
	Inferior 1 [process 12736] will be killed.
