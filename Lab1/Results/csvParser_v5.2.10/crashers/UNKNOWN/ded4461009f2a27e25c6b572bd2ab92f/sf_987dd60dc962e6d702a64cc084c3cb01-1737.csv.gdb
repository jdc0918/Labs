...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dtaBif/iteration_IuMbIi/BFF_testcase_i0fB8L/sf_987dd60dc962e6d702a64cc084c3cb01-1737.csv
...
siginfo:$1 = {si_signo = 6, si_errno = 0, si_code = -6, _sifields = {_pad = {14884, 1000, 0 <repeats 26 times>}, _kill = {si_pid = 14884, si_uid = 1000}, _timer = {si_tid = 14884, si_overrun = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _rt = {si_pid = 14884, si_uid = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _sigchld = {si_pid = 14884, si_uid = 1000, si_status = 0, si_utime = 0, si_stime = 0}, _sigfault = {si_addr = 0x3e800003a24, _addr_lsb = 0, _addr_bnd = {_lower = 0x0, _upper = 0x0}}, _sigpoll = {si_band = 4294967310884, si_fd = 0}}}
si_addr:$2 = (void *) 0x3e800003a24
...
#3  0x00007ffff71ee651 in malloc_printerr (ar_ptr=0x7fffffffc7e0, ptr=0x728370, str=0x7ffff72fd308 "malloc(): smallbin double linked list corrupted", action=3) at malloc.c:5006
        buf = "0000000000728370"
        cp = <optimized out>
        ar_ptr = 0x7fffffffc7e0
        ptr = 0x728370
...
#20 0x000000000040f955 in std::__detail::_NFA<std::__cxx11::regex_traits<char> >::_M_insert_matcher(std::function<bool (char)>) (this=0x6af770, __m=...) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_automaton.h:206
        __tmp = {<std::__detail::_State_base> = {_M_opcode = std::__detail::_Opcode::_S_opcode_match, _M_next = -1, {_M_subexpr = 4267845, _M_backref_index = 4267845, {_M_alt = 4267845, _M_neg = 192}}}, _M_matches = {<std::_Maybe_unary_or_binary_function<bool, char>> = {<std::unary_function<char, bool>> = {<No data fields>}, <No data fields>}, <std::_Function_base> = {static _M_max_size = 16, static _M_max_align = 8, _M_functor = {_M_unused = {_M_object = 0x7fffffffccb8, _M_const_object = 0x7fffffffccb8, _M_function_pointer = 0x7fffffffccb8, _M_member_pointer = (void (std::_Undefined_class::*)(std::_Undefined_class * const)) 0x7fffffffccb8, this adjustment 140737488342144}, _M_pod_data = "\270\314\377\377\377\177\000\000\200\314\377\377\377\177\000"}, _M_manager = 0x0}, _M_invoker = 0x7fffffffcd20}}
#21 0x000000000040e8fc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_insert_char_matcher<false, false> (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:391
No locals.
#22 0x000000000040d09f in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_atom (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:316
No locals.
#23 0x000000000040caa8 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_term (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:139
No locals.
#24 0x000000000040c7b9 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:121
No locals.
#25 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6af770, _M_start = 7, _M_end = 7}
#26 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6af770, _M_start = 5, _M_end = 5}
#27 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6af770, _M_start = 4, _M_end = 4}
#28 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6af770, _M_start = 2, _M_end = 2}
#29 0x0000000000406479 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_disjunction (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:97
No locals.
#30 0x0000000000405d58 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_Compiler (this=0x7fffffffd310, __b=0x7fffffffda08 "\"*\\s*,\\s*\"*", __e=0x7fffffffda13 "", __loc=..., __flags=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:82
        __r = {_M_nfa = @0x6af770, _M_start = 0, _M_end = 0}
#31 0x0000000000405a11 in std::__detail::__compile_nfa<char const*, std::__cxx11::regex_traits<char> > (__first=0x7fffffffda08 "\"*\\s*,\\s*\"*", __last=0x7fffffffda13 "", __loc=..., __flags=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.h:194
        __len = 11
        __cfirst = 0x7fffffffda08 "\"*\\s*,\\s*\"*"
#32 0x0000000000405932 in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::basic_regex<char const*> (this=0x7fffffffd9d0, __first=0x7fffffffda08 "\"*\\s*,\\s*\"*", __last=0x7fffffffda13 "", __loc=..., __f=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:766
No locals.
#33 0x000000000040586b in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::basic_regex<char const*> (this=0x7fffffffd9d0, __first=0x7fffffffda08 "\"*\\s*,\\s*\"*", __last=0x7fffffffda13 "", __f=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:512
No locals.
#34 0x0000000000404ec3 in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::basic_regex<std::char_traits<char>, std::allocator<char> > (this=0x7fffffffd9d0, __s=Python Exception <class 'gdb.error'> There is no member named _M_dataplus.: 
, __f=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:493
No locals.
#35 0x00000000004043c8 in main (argc=2, argv=0x7fffffffde18) at csvParser.cpp:73
...
rsi            0x3a24	14884
rdi            0x3a24	14884
rbp            0x7fffffffc750	0x7fffffffc750
rsp            0x7fffffffc3b8	0x7fffffffc3b8
r8             0x6	6
r9             0x0	0
r10            0x8	8
r11            0x246	582
r12            0x6f	111
r13            0x7fffffffc568	140737488340328
r14            0x7fffffffc568	140737488340328
r15            0x2	2
...
A debugging session is active.
	...
	Inferior 1 [process 14884] will be killed.
