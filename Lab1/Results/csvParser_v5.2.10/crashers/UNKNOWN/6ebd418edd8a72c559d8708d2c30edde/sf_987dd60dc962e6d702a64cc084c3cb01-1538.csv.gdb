...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dtaBif/iteration_8dxIYY/BFF_testcase_u6H6hN/sf_987dd60dc962e6d702a64cc084c3cb01-1538.csv
...
siginfo:$1 = {si_signo = 11, si_errno = 0, si_code = 1, _sifields = {_pad = {15102320, 0, 64324640, 0, -240534704, 32703, -1181788400, 32764, -240534672, 32703, 1181788401, -32765, -1181788401, 32764, 5863560, 0, 0, 0, 0, 0, 0, 0, 67620768, 0, 41069232, 0, -1181787660, 32764}, _kill = {si_pid = 15102320, si_uid = 0}, _timer = {si_tid = 15102320, si_overrun = 0, si_sigval = {sival_int = 64324640, sival_ptr = 0x3d58420}}, _rt = {si_pid = 15102320, si_uid = 0, si_sigval = {sival_int = 64324640, sival_ptr = 0x3d58420}}, _sigchld = {si_pid = 15102320, si_uid = 0, si_status = 64324640, si_utime = -1033088687233040384, si_stime = -5075742528792133697}, _sigfault = {si_addr = 0xe67170, _addr_lsb = 64324640, _addr_bnd = {_lower = 0x7fbff1a9bb50, _upper = 0x7ffcb98f5710}}, _sigpoll = {si_band = 15102320, si_fd = 64324640}}}
...
No locals.
#12 0x000000000040c84f in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:129
No locals.
#13 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6ae4b0, _M_start = 7, _M_end = 7}
#14 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6ae4b0, _M_start = 6, _M_end = 6}
#15 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6ae4b0, _M_start = 5, _M_end = 5}
#16 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6ae4b0, _M_start = 4, _M_end = 4}
#17 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6ae4b0, _M_start = 3, _M_end = 3}
#18 0x000000000040c7dc in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:124
        __re = {_M_nfa = @0x6ae4b0, _M_start = 2, _M_end = 2}
#19 0x0000000000406479 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_disjunction (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:97
No locals.
#20 0x000000000040d3ba in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_atom (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:334
        __r = {_M_nfa = @0x6ae4b0, _M_start = 1, _M_end = 1}
#21 0x000000000040caa8 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_term (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:139
No locals.
#22 0x000000000040c7b9 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_alternative (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:121
No locals.
#23 0x0000000000406479 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_M_disjunction (this=0x7fffffffd310) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:97
No locals.
#24 0x0000000000405d58 in std::__detail::_Compiler<std::__cxx11::regex_traits<char> >::_Compiler (this=0x7fffffffd310, __b=0x7fffffffda48 "(secret)", __e=0x7fffffffda50 "", __loc=..., __flags=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.tcc:82
        __r = {_M_nfa = @0x6ae4b0, _M_start = 0, _M_end = 0}
#25 0x0000000000405a11 in std::__detail::__compile_nfa<char const*, std::__cxx11::regex_traits<char> > (__first=0x7fffffffda48 "(secret)", __last=0x7fffffffda50 "", __loc=..., __flags=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex_compiler.h:194
        __len = 8
        __cfirst = 0x7fffffffda48 "(secret)"
#26 0x0000000000405932 in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::basic_regex<char const*> (this=0x7fffffffda58, __first=0x7fffffffda48 "(secret)", __last=0x7fffffffda50 "", __loc=..., __f=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:766
No locals.
#27 0x000000000040586b in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::basic_regex<char const*> (this=0x7fffffffda58, __first=0x7fffffffda48 "(secret)", __last=0x7fffffffda50 "", __f=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:512
No locals.
#28 0x0000000000404ec3 in std::__cxx11::basic_regex<char, std::__cxx11::regex_traits<char> >::basic_regex<std::char_traits<char>, std::allocator<char> > (this=0x7fffffffda58, __s=Python Exception <class 'gdb.error'> There is no member named _M_dataplus.: 
, __f=(unknown: 16)) at /usr/bin/../lib/gcc/x86_64-linux-gnu/5.4.0/../../../../include/c++/5.4.0/bits/regex.h:493
No locals.
#29 0x0000000000404290 in main (argc=2, argv=0x7fffffffde18) at csvParser.cpp:66
...
A debugging session is active.
	...
	Inferior 1 [process 14403] will be killed.
