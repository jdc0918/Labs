...
Running: /home/cs6340/csvParser /home/cs6340/fuzzing/campaign_dtaBif/iteration_tNi3aC/BFF_testcase_tWf5aO/sf_987dd60dc962e6d702a64cc084c3cb01-1142.csv
...
siginfo:$1 = {si_signo = 6, si_errno = 0, si_code = -6, _sifields = {_pad = {13372, 1000, 0 <repeats 26 times>}, _kill = {si_pid = 13372, si_uid = 1000}, _timer = {si_tid = 13372, si_overrun = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _rt = {si_pid = 13372, si_uid = 1000, si_sigval = {sival_int = 0, sival_ptr = 0x0}}, _sigchld = {si_pid = 13372, si_uid = 1000, si_status = 0, si_utime = 0, si_stime = 0}, _sigfault = {si_addr = 0x3e80000343c, _addr_lsb = 0, _addr_bnd = {_lower = 0x0, _upper = 0x0}}, _sigpoll = {si_band = 4294967309372, si_fd = 0}}}
si_addr:$2 = (void *) 0x3e80000343c
...
#3  0x00007ffff71ee651 in malloc_printerr (ar_ptr=0x7fffffffd040, ptr=0x6f4200, str=0x7ffff72fd2e0 "malloc(): memory corruption (fast)", action=3) at malloc.c:5006
...
A debugging session is active.
	...
	Inferior 1 [process 13372] will be killed.
